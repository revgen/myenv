# Mac OS tools and appliacations
...
| elinks            | ELinks is a free text-based console web browser. |
...
| imagemagick       | It is a suite for displaying, converting, and editing raster image and vector image files. |
